...
MACRO(SDP_ADD_LIBRARY _library_package _library_name)
	SET(_global_library_package SDP_${_library_package})
	...
	ADD_LIBRARY(sdp_${_library_name} ${${_library_package}_TYPE} ${${_library_package}_SOURCES})
	
	SET_TARGET_PROPERTIES(sdp_${_library_name} PROPERTIES
        VERSION ${LIBRARY_VERSION} SOVERSION ${LIBRARY_VERSION_MAJOR} )
...
MACRO(SDP_ADD_GUI_EXECUTABLE _package _name)
	...
	SET(${_package}_FILES_ "")
	
	SET(SDP_ROOT_SHARE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/../../../share)
	
	IF(APPLE)
        # set how it shows up in the Info.plist file
        SET(MACOSX_BUNDLE_ICON_FILE sdp.icns) 
        # set where in the bundle to put the icns file
        SET_SOURCE_FILES_PROPERTIES(${SDP_ROOT_SHARE_DIR}/sdp.icns PROPERTIES MACOSX_PACKAGE_LOCATION Resources)
        # include the icns file in the target
        SET(SDP_OSX_SRCS ${SDP_OSX_SRCS} ${SDP_ROOT_SHARE_DIR}/sdp.icns)
...
#            SET(MACOSX_BUNDLE_GUI_IDENTIFIER "com.ipgp.\${PRODUCT_NAME:identifier}")
	...
	TARGET_LINK_LIBRARIES(${_name} ${QT_QTWEBKIT_LIBRARY})
    ...
    IF(NOT APPLE)
    	INSTALL(TARGETS ${_name}
    		RUNTIME DESTINATION ${SDP_BIN_DIR} COMPONENT Runtime
    		ARCHIVE DESTINATION ${SDP_LIB_DIR}
    		LIBRARY DESTINATION ${SDP_LIB_DIR}
    	)
	ELSEIF(NOT APPLE)
	    INSTALL(TARGETS ${_name}
    		RUNTIME DESTINATION ${SDP_BIN_DIR} COMPONENT Runtime
            BUNDLE DESTINATION ${SDP_BIN_DIR} COMPONENT Runtime
    		ARCHIVE DESTINATION ${SDP_LIB_DIR}
    		LIBRARY DESTINATION ${SDP_LIB_DIR}
    	)
	ENDIF(NOT APPLE)
